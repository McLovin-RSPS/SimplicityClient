...
public class OnDemandFetcher extends OnDemandFetcherParent implements Runnable {
    ...
    public final void start(CacheArchive streamLoader, Client client) {
         ...
         * Seren
         */
        setMapData(currentCount++, 8259, 4002, 4003, true);
    ...
    int[] cheapHaxValues = new int[]{3627, 3628, 3655, 3656, 3625, 3626, 3629, 3630, 3650, 3651, 3668, 3669, 4071, 4072, 5253, 1816, 1817,
            ...
            4012, 3998, 3999, 4081, 4000, 4001, 4002, 4003, 3864, 3865, 3874, 3875};
