...
//        boolean removeObject = false;
        ...
        switch (i) {
            ...
            case 21764:
                ...
                break;
            case 123709:
                objectDef.actions = new String[]{"Restore-from", null, null, null, null};
                objectDef.name = "Box of Life";
                break;                
            case 11435:
                objectDef.actions = new String[]{"Cut", null, null, null, null};
    ...
    private void readValues667(Stream stream) {
        ...
        do {
            ...
            if (opcode == 1) {
				...
				configObjectIDs[len + 1] = value;
			} else if ((opcode == 78) || (opcode == 99) || (opcode == 100)) {
				...
				for (int ij = 0; ij < count; ij++) {
					byte str = (byte) stream.readUnsignedByte();
					if (str == 1) {
						stream.readString();
					} else {
						stream.readInt();
            	...
            	System.out.println("Unrecognized opcode 667 " + opcode + ".");
            	break;
            }
        } while (true);
        if (i == -1) {
