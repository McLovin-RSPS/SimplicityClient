...
public class JewelleryBoxTeleport extends RSInterface {
    ...
    public static void init(TextDrawingArea[] fonts) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            addSprite(currentWidgetId, 4155 + i, null, 160, 160);
            parent.child(currentChildId++, currentWidgetId++, x + 25, y + 15);

            addText(currentWidgetId, "Widget - "+ currentWidgetId, fonts, 0, 0xffffff);
            parent.child(currentChildId++, currentWidgetId++, x + 15, y + 47 + 6);

            for (int option = 0; option < 5; option++) {
                addClickableText(currentWidgetId, "Widget - "+ currentWidgetId, "Teleport", fonts, 0,
                        0xff981f, false, true, 128);
